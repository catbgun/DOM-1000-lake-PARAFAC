...
chemcatch <- read.table("1000 lakes joint 29102021_2.txt", sep = "\t", header = TRUE)
...
SNames$station_code = SNames$Stasjonskode
...
df2 <- merge(dfx, SNames, by  = "station_code") 
...
one.way <- aov(Comp1.R ~Region.4 , data = dx27)
